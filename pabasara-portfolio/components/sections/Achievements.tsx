...
export default function Achievements() {
  ...
  return (
    <>
      ...
      <section id="achievements" className="pt-8 pb-14 px-4 md:px-6 bg-surface animate-fade-up">
              ...
              {certifications.map((c, i) => (
                <div key={i} className="flex gap-4 md:gap-5 items-start">
                  <div className="flex flex-col items-center flex-shrink-0">
                    <div className="w-8 h-8 rounded-full bg-accent/15 border border-accent/30 icon-color-cycle-ring flex items-center justify-center mt-0.5">
                      <Award size={14} className="icon-color-cycle" />
                    </div>
