...
github: "https://github.com/PabasaraIlankoon/elevision-device",
  ...
  },
  {
    id: 7,
    title: "FeelFill",
    subtitle: "Smart Measuring Cup for the Visually Impaired",
    description:
      "A low-cost, clip-on capacitive Level sensor that guides blind users through voice and haptic feedback for safe, accurate pouring.",
    longDescription:
      "FeelFill restores kitchen independence for visually impaired users by providing real-time non-contact fill measurements and voice guidance during every pour. Designed around a persona, validated by empathy research, and engineered to fit standard cups without any visual display, the device uses an ESP32, DFPlayer Mini voice module, and a vibration motor to deliver safe, inclusive pouring feedback.\n\n" +
      "The system is built with non-contact capacitive sensing outside the cup wall, a universal silicone sleeve for 50–100 mm cup diameters, and a snap-fit ABS enclosure for easy attachment. Deep-sleep firmware preserves battery life longer than 8 hours, while the user never needs a smartphone, screen, or digital literacy. Cost goals target under 8,000 LKR for accessible, affordable assistive technology.",
    highlights: [
      "Voice feedback at 25%, 50%, 75%, 95%, and 100% fill levels",
      "Near-full haptic warning prevents overflow before it happens",
      "Non-contact copper strip sensing keeps the system hygienic for hot liquids",
      "Adjustable clip fits 50–100 mm cup diameters without tools",
      "Battery-powered 18650 + USB-C charging with idle deep-sleep current <1 mA",
      "Designed for inclusive use: no screen, no smartphone, no literacy required",
      "Estimated BOM cost 5,100–7,800 LKR with batch production targeting 2,500 LKR",
      "Captures real user needs through Design Thinking and persona-led empathy research",
    ],
    images: [
      "/images/feelfill-hero.jpg",
      "/images/feelfill-cup.jpg",
      "/images/feelfill-assembly.jpg",
      "/images/feelfill-sensor.jpg",
    ],
    category: "Assistive Technology",
    year: "2026",
    status: "ongoing",
    featured: false,
    image: "/images/feelfill-hero.jpg",
    tech: [
      "ESP32",
      "Capacitive sensing",
      "DFPlayer Mini",
    ...
    github: "https://github.com/PabasaraIlankoon/FeelFill",
    highlight: "Smart, non-contact measuring cup for visually impaired users",
  },
  {
    id: 3,
